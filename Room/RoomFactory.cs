...
namespace DungeonExplorer
{
    ...
    public class RoomFactory
    {
        ...
        string[,] roomData = {
            { "1", "Library", "A dusty library full of sorcery tomes and alchemy books. The air feels tense and you feel strange. You see something glistening at the top of a shelf... and is that a door at the east end of the room?", "-1", "3", "-1", "-1"},
            ...
            { "6", "Garden",  "A wilted garden, once vibrant, now overrun with dry, brittle plants and the scent of decay in the air.", "4", "-1", "-1", "-1"},
            { "7", "Prison Cell", "A small, damp prison cell with cold stone walls and a rusted bed frame. You can almost hear... breathing?", "-1", "-1", "-1", "2"}
        };
